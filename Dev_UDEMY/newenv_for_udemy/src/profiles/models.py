...
class Profile(models.Model):
    user              = models.OneToOneField(User,null=True) # user.profile
    followers         = models.ManyToManyField(User, related_name='is_following', blank=True,null=True) # user.is_following.all()
